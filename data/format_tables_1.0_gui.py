...
# -*- coding: utf-8 -*-
"""
Word表格批量格式化工具 - 顶线/底线 1.0 磅实线版 (GUI版)
功能：
  1. 表格内部全部 0.5 虚线
  2. 表格左右两侧边线空白
  3. 表格顶部和底部 1.0 实线
...
class FormatApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Word表格批量格式化工具 - 顶线/底线 1.0 磅实线")
        ...
        # 说明
        tk.Label(root, text="说明：顶线/底线 1.0 磅实线 | 内部 0.5 磅虚线 | 左右空白 | 首行底线 0.5 磅实线",
